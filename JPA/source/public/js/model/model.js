...
//*********************************************  
    ...
    async function __async_test() {      
        let response  = await fetch('api/test',{method: 'POST', headers: {'Content-Type': 'application/json;charset=utf-8'},body: JSON.stringify(_students.get())})        
